...
// This array will hold all of the objects generated by the inquirer questions
const employeesList = [];
...
// Initialize the application starting with a request for the manager information and push the manager object to the employeesList array and then prompt to add another employee//
function init() {
...
// Ask the user if they would like to add another employee: Engineer, Intern or None. Based on input, continue to specific employee information and push the object to the employeesList OR terminate inquirer and proceed to generate HTML page
